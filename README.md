...
> [!WARNING] Your data lives in your browser's `localStorage`. This is a small local database managed by your browser. It is **not** a file on your hard drive, and it can be wiped by:
